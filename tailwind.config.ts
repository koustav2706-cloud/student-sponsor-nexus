		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					...
					'50%': { boxShadow: '0 0 40px hsl(var(--primary) / 0.5), 0 0 20px hsl(var(--accent) / 0.3)' }
				},
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--primary) / 0.5)' },
					'50%': { boxShadow: '0 0 20px hsl(var(--primary) / 0.8), 0 0 30px hsl(var(--primary) / 0.3)' }
				},
				'shimmer': {
			...
			boxShadow: {
				...
				'neumorphic': 'var(--shadow-neumorphic-light)',
